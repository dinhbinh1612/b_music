...
class SignupOptionsScreenPage extends StatelessWidget {
  const SignupOptionsScreenPage({super.key});
    ...
    return Column(
      ...
      children: [
        ...
        IconButtonFilled(
          ...
          onPressed: () {
            Navigator.pushNamed(context, AppRoutes.emailPut);
          },
        ),
        SizedBox(height: 16.sp),
        IconButtonFilled(
        ...
        TextButton(
          ...
          onPressed: () {
            Navigator.pushReplacementNamed(context, AppRoutes.signInOptions);
          },
          child: Text(
            'Đăng nhập',
            style: TextStyle(
